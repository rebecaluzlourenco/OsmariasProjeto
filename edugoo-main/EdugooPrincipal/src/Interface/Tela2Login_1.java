 ...
 * @author rebec
 */
public class Tela2Login_1 extends javax.swing.JFrame {

    /**
     * Creates new form Tela2Login_2
     */
    public Tela2Login_1() {
        initComponents();
    }
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        Tela3CadastroUsuario_1 tela = new Tela3CadastroUsuario_1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela2Login_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela2Login_1().setVisible(true);
            }
        });
    }
