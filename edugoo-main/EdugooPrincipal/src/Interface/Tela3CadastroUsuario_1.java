 ...
 * @author rebec
 */
public class Tela3CadastroUsuario_1 extends javax.swing.JFrame {

    /**
     * Creates new form Tela3CadastroUsuario_1
     */
    public Tela3CadastroUsuario_1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnSalvar_Cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 410, 120, 40));
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
        Tela2Login_1 tela = new Tela2Login_1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela3CadastroUsuario_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tela3CadastroUsuario_1().setVisible(true);
            }
        });
    }
